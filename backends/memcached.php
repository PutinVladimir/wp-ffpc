...
// Patched by Serg - bug https://github.com/php-memcached-dev/php-memcached/issues/400
...
//$memcached = fsockopen ("unix:///var/run/memcached/memcached.sock", -1, $errno, $errstr);
$memcached = pfsockopen ("unix:///var/run/memcached/memcached.sock", -1, $errno, $errstr);
...
if (strpos($key, '-data-') !== false) {
    ...
    $result = fwrite($memcached, "set {$key} {$flags} {$expire} {$length} \r\n{$data}\r\n");
